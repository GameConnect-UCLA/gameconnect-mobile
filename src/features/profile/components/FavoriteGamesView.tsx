      ...
      <SafeAreaView style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          <View style={styles.bigCard}>
            ...
            <SearchBar value={searchQuery} onChangeText={setSearchQuery} placeholder="Buscar juegos..." />
...
const styles = StyleSheet.create({
  ...
  bigCard: {
    backgroundColor: Colors.surfaceDark, borderRadius: 30, padding: Spacing.lg, minHeight: '100%',
  },
  headerRow: {
  ...
  sectionTitle: { fontFamily: 'Inter', fontWeight: '600', fontSize: Typography.sizes.xl, color: '#000000' },
  gridContainer: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' },
  gameItem: { width: '48%', marginBottom: 25 },
  gameImage: { width: '100%', height: 100, borderRadius: Radii.sm, backgroundColor: '#333' },
  gameTitle: { fontFamily: 'Inter', fontWeight: '600', fontSize: Typography.sizes.md, color: '#000000', marginTop: Spacing.sm, textAlign: 'center' },
  gameDescription: {
    fontFamily: 'Inter', fontWeight: '400', fontSize: Typography.sizes.xs, color: '#000000',
    marginTop: 6, textAlign: 'justify', lineHeight: 15,
  },
})
