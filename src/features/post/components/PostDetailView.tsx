...
const styles = StyleSheet.create({
  topHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: 45, paddingBottom: 20 },
  headerTitle: { fontSize: 20, fontWeight: 'bold', color: '#000', fontFamily: 'Inter' },
  headerLine: { height: 1, backgroundColor: '#000', opacity: 0.1, marginHorizontal: 30 },
  postContent: { padding: 5 },
  reviewInfo: { marginTop: 10, paddingHorizontal: 15 },
  reviewLabel: { fontSize: Typography.sizes.md, color: '#666' },
  reviewGame: { fontSize: Typography.sizes.xl, fontWeight: 'bold', color: '#000', marginTop: 2 },
  inputBar: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15, paddingVertical: 30, backgroundColor: 'transparent' },
  inputAvatar: { width: 48, height: 48, borderRadius: Radii.xl, marginRight: 10, borderWidth: 2, borderColor: '#FFF' },
  inputBubble: { flex: 1, height: 45, backgroundColor: 'rgba(200, 200, 200, 0.7)', borderRadius: 25, paddingHorizontal: 18, justifyContent: 'center' },
  textInput: { color: '#000', fontSize: 15 },
  sendIcon: { marginLeft: Spacing.md },
  successToast: { position: 'absolute', bottom: 90, backgroundColor: Colors.primary, paddingHorizontal: 20, paddingVertical: 10, borderRadius: 20, alignSelf: 'center', zIndex: 1000 },
