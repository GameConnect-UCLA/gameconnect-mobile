...
/** Render the replied-to message inside a bubble with thumbnail @param props.message - The original message @param props.isOwnMessage - Whether it belongs to current user */
