/** Active user avatar with online indicator */
import { ActiveUser } from '../../types/chat.types';
...
/** Circular avatar with green online dot and spring press animation @param props.user - Active user data @param props.onPress - Tap handler */
