/** Chat info screen with profile, media, links, and member management */
...
import { blockUser, unblockUser } from '../api/chat.api';
import ChatMediaGrid from '../components/chat-room/ChatMediaGrid';
import ChatLinkList from '../components/chat-room/ChatLinkList';
...
const TAB_LABELS = ["Media", "Enlaces"] as const;
type Tab = (typeof TAB_LABELS)[number];

/** Conversation info screen: profile, shared media/links, members, and actions */
export default function ChatInfoScreen() {
  ...
  const { sharedMedia, sharedLinks, contactInfo, contactUserId } =
  ...
  }, [selectedMember, promoteMember, showToast]);
  ...
  const handleDemote = useCallback(async () => {
    ...
    setMemberActionVisible(false);
    setSelectedMember(null);
  }, [selectedMember, demoteMember, showToast]);
  ...
  }, [selectedMember, removeMember, confirm, showToast]);
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.actionRow}>
            ...
            >
              ...
              <Text style={styles.actionButtonText}>{strings.chat.info.message}</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.actionButton}
              onPress={() =>
