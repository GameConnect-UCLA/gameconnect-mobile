  ...
  posts: [
    {
      ...
      author_profile_pic: 'https://m.media-amazon.com/images/S/aplus-media-library-service-media/94865395-9e45-4e4b-9f4f-fac723fbf713.__CR0,0,362,453_PT0_SX362_V1___.jpg',
      ...
      comments_counter: 50,
      comments: [
        { id: 'c1', author_id: 'user1', author_display_name: 'Isaac Clarke', author_profile_pic: 'https://i.pravatar.cc/150?u=isaac', content: '¡Esa armadura se ve genial!', created_at: 'Hace 2 horas' },
        { id: 'c2', author_id: 'user2', author_display_name: 'Nicole Brennan', author_profile_pic: 'https://i.pravatar.cc/150?u=nicole', content: 'Ten cuidado en la Ishimura...', created_at: 'Hace 1 hora' }
      ],
